...
using ReactClientCustomerAppointmentWithMVC_API.Mappings;
using ReactClientCustomerAppointmentWithMVC_API.Models;
using ReactClientCustomerAppointmentWithMVC_API.SQL;

namespace ReactClientCustomerAppointmentWithMVC_API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<ICustomerSupportRepository, SQLCustomerSupportRepository>();
            services.AddScoped<ICustomerSupportAppointmentRepository, SQLCustomerSupportAppointmentRepository>();
