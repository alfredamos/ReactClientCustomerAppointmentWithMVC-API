...
import { faTrash, faEdit, faBookOpen, faCheck, faPeopleArrows} from '@fortawesome/free-solid-svg-icons';
import { SearchItem } from '../Utilities/Helpers/SearchItem';
import axios from 'axios';

export const UnConfirmedAppointments = (props) => {
        ...
        axios.get(appointmentUrl)
            .then(res => {
                if (onMount) {
                    ...
                    const filteredAppointments = allAppointments.filter(x => x.isConfirmed === false);
                ...
                <section>
                    <div className="border">
                        <div className="card-header text-center">
                            <h4>List of  Appointments To Confirm</h4>
                        </div>
                        <div className="card-body">
                            ...
                            <table className="table table-bordered table-striped">
                                ...
                                <tbody>
                                    {
                                        appointments.length === 0 ? "No available data" :
                                                ...
                                                <tr key={appointment.name}>
                                                    ...
                                                    <td>
                                                        <button onClick={() => confirmHandler(appointment.appointmentID)} className="btn btn-success" style={{ fontWeight: "bold" }}><FontAwesomeIcon icon={faCheck} /></button>
                                                    </td>
                                                    <td>
