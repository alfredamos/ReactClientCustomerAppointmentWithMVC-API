...
export const AllAppointments = (props) => {
    ...
    const confirmHandler = (appointment) => {        
        appointment.isConfirmed = true;        
        axios.put(`${appointmentUrl}/${appointment.appointmentID}`, appointment)
            .then(res => {
                props.history.replace('/confirmedAppointments')
            });
    }
                                                ...
                                                <td>                                                    
                                                    {
                                                        !appointment.isConfirmed ?
                                                         ...
                                                         <button onClick={() => confirmHandler(appointment)} className="btn btn-success" style={{ fontWeight: "bold" }}><FontAwesomeIcon icon={faCheck} /></button>
                                                         :
                                                         <h6>YES</h6>
                                                    }                                                     
                                                </td>
